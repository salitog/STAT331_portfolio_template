...
Importing tidyverse and here libraries.
...
The summary above, although verbose, gives us a very good structure to out data. We can see that almost every variable is a number (num) and that only the variables: word, subj, sex, and ethnic are characters (chr). Our data's dimensions are 10752 x 38.
